class Board:
    ...
    def create_initial_board(self):
        ...
        initial_board.append(['black rook', 'black knight', 'black bishop', 'black queen', 'black king', 'black bishop', 'black knight', 'black rook'])  # Ligne des pièces noires
        ...
        initial_board.append(['white rook', 'white knight', 'white bishop', 'white queen', 'white king', 'white bishop', 'white knight', 'white rook'])  # Ligne des pièces blanches
